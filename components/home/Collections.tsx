    ...
    <section className="py-20 px-4 bg-parchment-100 border-t border-olive-100">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Wine */}
          <div className="border border-olive-200 bg-white p-10 flex flex-col items-start">
            <span className="text-[10px] font-medium text-olive-400 uppercase tracking-[0.25em] mb-6">Category</span>
            <div className="w-8 h-8 flex items-center justify-center mb-5 opacity-40">
            ...
            <h3 className="text-2xl font-serif font-bold text-olive-900 mb-2">Wine</h3>
          ...
          <div className="border border-olive-200 bg-white p-10 flex flex-col items-start">
            ...
            <h3 className="text-2xl font-serif font-bold text-olive-900 mb-2">Olive Oil</h3>
            <p className="text-sm text-olive-500 leading-relaxed">
              Cold-pressed extra virgin oils from family groves — harvested at peak ripeness.
            </p>
          </div>
        </div>
      </div>
